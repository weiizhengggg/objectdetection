...
data_root = '/kaggle/input/dior-with-coco/DIOR/'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='dior_coco/DIOR_train_coco.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(classes=classes),
        data_root=data_root,
        ann_file='dior_coco/DIOR_val_coco.json',
        data_prefix=dict(img='JPEGImages-trainval/'),
        test_mode=True,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(classes=classes),
        data_root=data_root,
        ann_file=data_root + 'dior_coco/DIOR_test_coco.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'dior_coco/DIOR_val_coco.json',
    metric='bbox',
    format_only=False,
    backend_args=backend_args)
...
test_evaluator = dict(
    ...
    format_only=True,
    ann_file=data_root + 'dior_coco/DIOR_test_coco.json',
    outfile_prefix='./work_dirs/dior_coco_detection/test')
